...
[ExecuteInEditMode]
public class ArcherCameraController : MonoBehaviour
{
    ...
    void RotateCamera()
    {
        ...
        Quaternion rotation = Quaternion.Slerp(mainCam.transform.localRotation, Quaternion.Euler(rotatingAngle), cameraSettings.rotationSpeed * Time.deltaTime);
